...
class User extends CI_Controller
{
    ...
    public function data(){
        ...
        // List field
        $columns = array(
            array('db' => 'id_users', 'dt' => 'id_users'),
            array('db' => 'full_name', 'dt' => 'full_name'),
            array('db' => 'full_name', 'dt' => 'full_name'),
            array('db' => 'email', 'dt' => 'email'),
            array('db' => 'is_aktif', 'dt' => 'is_aktif'),
            array(
                'db' => 'id_users',
                'dt' => 'aksi',
                'formatter' => function( $d, $row ) {
                    ...
                    anchor('provinces/delete/'.$key = $this->encryptions->encode($d,$this->config->item('encryption_key')),'<i class="fa fa-trash"></i>',"class='label bg-red'",'onclick="javasciprt: return confirm(\'Are You Sure ?\')"','id_users');
    ...
    function upload_foto(){
        ...
        // Untuk menangani gaagal baca nama file upload
