<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2><?php echo $button ?> Data <small>Agama</small></h2> &nbsp&nbsp&nbsp&nbsp
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">Import DataTbl_refagama</h4>
                        </div>
                        <div class="modal-body">
                            <!-- form start sesuiakan controller/upload-->
                                    <form action="<?php echo site_url();?>agama/upload/" enctype="multipart/form-data" method="post">  
                                      <div class="box-body">
...
<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo site_url('agama') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
