                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">Import Data Tbl_sekolah_copy</h4>
                        </div>
                        <div class="modal-body">
                            <!-- form start sesuiakan controller/upload-->
                                    <form action="<?php echo site_url();?>tblsekolahcopy/upload/" enctype="multipart/form-data" method="post">  
                                      <div class="box-body">
...
<tr>
                                                    <td width="200">
                                                        Nilai Akreditasi <?php echo form_error('nilai_akreditasi') ?>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="nilai_akreditasi" id="nilai_akreditasi" placeholder="Nilai Akreditasi" value="<?php echo $nilai_akreditasi; ?>" />
                                                    </td>
                                                </tr>
<tr>
                                                    <td width="200">
...
<tr>
                                                    <td width="200">
                                                        File Npwp <?php echo form_error('file_npwp') ?>
                                                    </td>
                                                    <td>
...
<tr>
                                                    <td width="200">
                                                        Tgl Input <?php echo form_error('tgl_input') ?>
                                                    </td>
                                                    <td>
...
<tr>
                                                    <td width="200">
                                                        User Input <?php echo form_error('user_input') ?>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="user_input" id="user_input" placeholder="User Input" value="<?php echo $user_input; ?>" />
                                                    </td>
                                                </tr>
<tr>
                                                    <td width="200">
                                                        User Update <?php echo form_error('user_update') ?>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" name="user_update" id="user_update" placeholder="User Update" value="<?php echo $user_update; ?>" />
                                                    </td>
                                                </tr>
<tr>
                                                    <td width="200">
                                                        Tgl Update <?php echo form_error('tgl_update') ?>
                                                    </td>
                                                    <td>
...
<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo site_url('tblsekolahcopy') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
