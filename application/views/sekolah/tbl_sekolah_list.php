    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <?php echo anchor(site_url('sekolah/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-warning"'); ?>
                <?php echo anchor(site_url('sekolah/excel'), '<i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-sm btn-success"'); ?>
    ...
    $(document).ready(function() {
        ...
        var t = $("#mytable").dataTable({
            ...
            columns: [
            {
                ...
                "orderable": true
            },{"data": "npsn"},{"data": "nama_bentuk"},{"data": "nama_sekolah"},{"data": "status_sekolah"},{"data": "name_reg"},{"data": "name_dist"},
            {
                "data" : "action",
                "orderable": false,
                "className" : "text-center"
