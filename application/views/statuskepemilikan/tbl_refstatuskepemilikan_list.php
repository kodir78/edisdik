...
<div class="row" >
    <div class="col-md-4">
        <h2 style="margin-top:0px">Daftar Status Kepemilikan</h2>
    </div>
    <!-- message -->
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <?php echo anchor(site_url('statuskepemilikan/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-warning"'); ?>
                <?php echo anchor(site_url('statuskepemilikan/excel'), '<i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-sm btn-success"'); ?>
                <!-- /Button Create | Export -->
                <!-- Judul --> 
                <!-- <h2>Tbl_refstatuskepemilikan </h2> -->
                <!-- /Judul --> 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        "ajax": '<?php echo site_url('statuskepemilikan/data')?>',
        "order": [[ 2, 'asc' ]],
