...
<div class="row" >
    <div class="col-md-4">
        <h2 style="margin-top:0px">Daftar Jenis PTK</h2>
    </div>
    <!-- message -->
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <?php echo anchor(site_url('jenisptk/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-warning"'); ?>
                <?php echo anchor(site_url('jenisptk/excel'), '<i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-sm btn-success"'); ?>
                <!-- /Button Create | Export -->
                <!-- Judul --> 
                <!-- <h2>Tbl_refjenisptk </h2> -->
                <!-- /Judul --> 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        "ajax": '<?php echo site_url('jenisptk/data')?>',
        "order": [[ 2, 'asc' ]],
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "jenisptk/json", "type": "POST"},
            columns: [
            {
                "data": "id_jenisptk",
                "orderable": true
            },{"data": "nama_jenisptk"},{"data": "tgl_input"},{"data": "user_input"},{"data": "tgl_update"},{"data": "user_update"},
            {
                "data" : "action",
                "orderable": false,
                "className" : "text-center"
