<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?><div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Tampil Data <small>Induk OPD</small></h2> &nbsp&nbsp&nbsp&nbsp
...
<tr>
                    <td width="200">Nama Induk Opd <?php echo form_error('nama_induk_opd') ?></td><td><input type="text" readonly=""  class="form-control" name="nama_induk_opd" id="nama_induk_opd" placeholder="Nama Induk Opd" value="<?php echo $nama_induk_opd; ?>" /></td>
                    </tr>
<tr>
...
<tr>
                    <td></td><td> <a href="<?php echo site_url('indukopd') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
                    </tr>
            </table>
           </div>   
        </div>
