...
<head>
    ...
    <!-- <title>SIM <?php echo getInfoSM('nama_lembaga')?></title> -->
    ...
    <div>
      ...
      <div class="login_wrapper">
        ...
        <div class="separator">
              ...
              <div>
                  <h2><?php echo getInfoSM('nama_lembaga')?></h2>
                  <p>©2018 All Rights Reserved. design by <b>Kodir Zaelani</b></p>
              </div>
          </div>
      </form>
  </section>
