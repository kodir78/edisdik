<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2><?php echo $button ?> Data <small>Villages</small></h2> &nbsp&nbsp&nbsp&nbsp
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">Import DataVillages</h4>
                        </div>
                        <div class="modal-body">
                            <!-- form start sesuiakan controller/upload-->
                                    <form action="<?php echo site_url();?>villages/upload/" enctype="multipart/form-data" method="post">  
                                      <div class="box-body">
...
<tr>
                                                    <td width="200">
                                                        District Id <?php echo form_error('district_id') ?>
                                                    </td>
                                                    <td>
...
<tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" name="id_villages" value="<?php echo $id_villages; ?>" /> 
                                                        <button type="submit" class="btn btn-success"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button>&nbsp&nbsp&nbsp&nbsp
                                                        <a href="<?php echo site_url('villages') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </form>
