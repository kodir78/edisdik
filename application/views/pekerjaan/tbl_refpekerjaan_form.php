<div class="">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2><?php echo $button ?> Data <small>Jenis Pekerjaan</small></h2> &nbsp&nbsp&nbsp&nbsp
        <button type="button" class="btn btn-info" data-toggle="modal" data-target=".bs-example-modal-lg">Import</button> &nbsp&nbsp
        <ul class="nav navbar-right panel_toolbox">
          <li> <a href="<?php echo site_url('pekerjaan') ?>"><i class="fa fa-sign-out"></i></a></li>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Import DataTbl_refpekerjaan</h4>
            </div>
            <div class="modal-body">
              <!-- form start sesuiakan controller/upload-->
              <form action="<?php echo site_url();?>pekerjaan/upload/" enctype="multipart/form-data" method="post">  
                <div class="box-body">
      ...
      <div class="x_content">
       ...
       <form action="<?php echo $action; ?>" method="post">
        <table class="table table-bordered table-responsive">
          <tr>
            <td width="200">
              Nama Pekerjaan <?php echo form_error('nama_pekerjaan') ?>
            </td>
            <td>
              <input type="text" class="form-control" name="nama_pekerjaan" id="nama_pekerjaan" placeholder="Nama Pekerjaan" value="<?php echo $nama_pekerjaan; ?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              ...
              <a href="<?php echo site_url('pekerjaan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
            </td>
          </tr>
        </table>
      </form>
