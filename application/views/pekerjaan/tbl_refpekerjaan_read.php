<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?><div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Tampil Data <small>Jenis Pekerjaan</small></h2> &nbsp&nbsp&nbsp&nbsp
...
<tr>
                    <td width="200">Nama Pekerjaan <?php echo form_error('nama_pekerjaan') ?></td><td><input type="text" readonly=""  class="form-control" name="nama_pekerjaan" id="nama_pekerjaan" placeholder="Nama Pekerjaan" value="<?php echo $nama_pekerjaan; ?>" /></td>
                    </tr>
<tr>
...
<tr>
                    <td></td><td> <a href="<?php echo site_url('pekerjaan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
                    </tr>
            </table>
           </div>   
        </div>
