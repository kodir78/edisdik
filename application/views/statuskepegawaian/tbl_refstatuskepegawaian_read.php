<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?><div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Tampil Data <small>Status Kepegawaian</small></h2> &nbsp&nbsp&nbsp&nbsp
...
<tr>
                    <td width="200">Nama Status Kepegawaian <?php echo form_error('nama_status_kepegawaian') ?></td><td><input type="text" readonly=""  class="form-control" name="nama_status_kepegawaian" id="nama_status_kepegawaian" placeholder="Nama Status Kepegawaian" value="<?php echo $nama_status_kepegawaian; ?>" /></td>
                    </tr>
<tr>
...
<tr>
                    <td></td><td> <a href="<?php echo site_url('statuskepegawaian') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
                    </tr>
            </table>
           </div>   
        </div>
