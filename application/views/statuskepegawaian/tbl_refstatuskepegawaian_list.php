<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?>
	 <div class="row" >
                    <div class="col-md-4">
                        <h2 style="margin-top:0px">Daftar Status Kepegawaian</h2>
                    </div>
                    <!-- message -->
		...
		<?php echo anchor(site_url('statuskepegawaian/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-warning"'); ?>
		<?php echo anchor(site_url('statuskepegawaian/excel'), '<i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-sm btn-success"'); ?>
		<!-- /Button Create | Export -->
                <!-- Judul --> 
                <!-- <h2>Tbl_refstatuskepegawaian </h2> -->
                <!-- /Judul --> 
...
$(document).ready(function() {
    var t =$('#mytable').DataTable( {
        ...
        "ajax": '<?php echo site_url('statuskepegawaian/data')?>',
        "order": [[ 2, 'asc' ]],
