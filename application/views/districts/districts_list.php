<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?>
	 <div class="row" >
                    <div class="col-md-4">
                        <h2 style="margin-top:0px">Daftar Districts</h2>
                    </div>
                    <!-- message -->
		...
		<?php echo anchor(site_url('districts/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-warning"'); ?>
		<?php echo anchor(site_url('districts/excel'), '<i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-sm btn-success"'); ?>
		<!-- /Button Create | Export -->
                <!-- Judul --> 
                <!-- <h2>Districts </h2> -->
                <!-- /Judul --> 
...
$(document).ready(function() {
    var t =$('#mytable').DataTable( {
        ...
        "ajax": '<?php echo site_url('districts/data')?>',
        "order": [[ 2, 'asc' ]],
        ...
        {"data": "regency_id"},{"data": "name_dist"},
        {
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "districts/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_districts",
                            "orderable": true
