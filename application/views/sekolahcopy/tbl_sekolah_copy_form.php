<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2><?php echo $button ?> Data <small>Tbl_sekolah_copy</small></h2> &nbsp&nbsp&nbsp&nbsp
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Import DataTbl_sekolah_copy</h4>
      </div>
      <div class="modal-body">
        <!-- form start sesuiakan controller/upload-->
        <form action="<?php echo site_url();?>sekolahcopy/upload/" enctype="multipart/form-data" method="post">  
          <div class="box-body">
...
<div class="x_content">
   ...
   <form action="<?php echo $action; ?>" method="post">
    <table class="table table-bordered table-responsive">
        ...
        <tr>
            <td width="200">
                Bentuk Sekolah <?php echo form_error('id_bentuk_sekolah') ?>
            </td>
            <td>
                <?php echo cmb_dinamis('id_bentuk_sekolah', 'tbl_refbentuksekolah', 'nama_bentuk', 'id_bentuk_sekolah', $id_bentuk_sekolah) ?>
        ...
        <tr>
            ...
            <td>
                <?php echo form_dropdown('status_sekolah',array('Negeri'=>'Negeri','Swasta'=>'Swasta'),$status_sekolah,array('class'=>'form-control'))?>
        ...
        <tr>
            <td width="200">
                Status Kepemilikan <?php echo form_error('id_status_kepemilikan') ?>
            </td>
            <td>
                <?php echo cmb_dinamis('id_status_kepemilikan', 'tbl_refstatuskepemilikan', 'nama_status_kepemilikan', 'id_status_kepemilikan', $id_status_kepemilikan) ?>
        ...
        <tr>
            <td width="200">
                SKPD Pembina <?php echo form_error('id_opdpembina') ?>
            </td>
            <td>
                <?php echo cmb_dinamis('id_opdpembina', 'tbl_refindukopd', 'nama_induk_opd', 'id_opdpembina', $id_opdpembina) ?>
        ...
        <tr>
            ...
            <td>
                <?php echo form_dropdown('mbs',array('Y'=>'Ya','T'=>'Tidak'),$mbs,array('class'=>'form-control'))?>
                <!-- <input type="text" class="form-control" name="mbs" id="mbs" placeholder="Mbs" value="<?php echo $mbs; ?>" /> -->
            </td>
        </tr>
        <tr>
            <td width="200">
                Siap Menerima Bos <?php echo form_error('penerima_bos') ?>
            </td>
            <td>
                <?php echo form_dropdown('penerima_bos',array('Y'=>'Ya','T'=>'Tidak'),$penerima_bos,array('class'=>'form-control'))?>
        ...
        <tr>
            ...
            <td>
                <?php echo form_dropdown('sertifikat_iso',array('Belum'=>'Belum','Dalam Proses'=>'Dalam Proses','Pernah'=>'Pernah','Sudah'=>'Sudah'),$sertifikat_iso,array('class'=>'form-control'))?>
        ...
        <tr>
            <td width="200">
                Akreditasi Saat Ini <?php echo form_error('nilai_akreditasi') ?>
            </td>
            <td>
                <?php echo form_dropdown('nilai_akreditasi',array('Belum'=>'Belum','C'=>'C','B'=>'B','A'=>'A'),$nilai_akreditasi,array('class'=>'form-control'))?>
                <!-- <input type="text" class="form-control" name="sertifikat_iso" id="sertifikat_iso" placeholder="Sertifikat Iso" value="<?php echo $sertifikat_iso; ?>" /> -->
            </td>
        </tr>
        <tr>
            <td width="200">
                Kategori Wilayah <?php echo form_error('id_kategori_wilayah') ?>
            </td>
            <td>
                <?php echo cmb_dinamis('id_kategori_wilayah', 'tbl_refkategoriwilayah', 'nama_kategori_wilayah', 'id_kategori_wilayah', $id_kategori_wilayah) ?>
        ...
        <tr>
            <td width="200">
                Waktu Penyelengaraan <?php echo form_error('id_waktu_penyelengaraan') ?>
            </td>
            <td>
                <?php echo cmb_dinamis('id_waktu_penyelengaraan', 'tbl_refwaktupenyelenggaraan', 'nama_waktu', 'id_waktu_penyelengaraan', $id_waktu_penyelengaraan) ?>
        ...
        <tr>
            <td width='200'>
                Tanggal SK Pendirian <?php echo form_error('tgl_sk') ?>
            </td>
            <td>
         ...
         <tr>
            ...
            <td>
                <input type="file" class="form-control" name="file_pendirian" id="file_pendirian" placeholder="File Pendirian" value="<?php echo $file_pendirian; ?>" />
            </td>
        </tr>
        <tr>
            <td width="200">
                Provinsi <?php echo form_error('province_id') ?>
            </td>
            <td>
        ...
        <tr>
            <td width="200">
                Kabupaten/Kota <?php echo form_error('regency_id') ?>
            </td>
            <td>
        ...
        <tr>
            <td width="200">
                Kecamatan <?php echo form_error('id_districts') ?>
            </td>
            <td>
        ...
        <tr>
            <td width="200">
                Desa/Kelurahan <?php echo form_error('id_villages') ?>
            </td>
            <td>
        ...
        <tr>
            <td width="200">
                Kode Pos <?php echo form_error('postal_code') ?>
            </td>
            <td>
        ...
        <tr>
            <td width="200">
                Luas Tanah Milik <?php echo form_error('luas_tanahmilik') ?>
            </td>
            <td>
        ...
        <tr>
            <td width="200">
                Luas Tanah Bukan Milik <?php echo form_error('luas_tanahbukanmilik') ?>
            </td>
            <td>
        ...
        <tr>
            <td width="200">
                Nama Wajib Pajak <?php echo form_error('nama_wajibpajak') ?>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo site_url('sekolahcopy') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
            </td>
        </tr>
    </table>
</form>
