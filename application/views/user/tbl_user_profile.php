        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-rounded" src="<?php echo base_url() ?>assets/foto_profil/<?php echo $this->session->userdata('images'); ?> " alt="User profile picture" >
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img class="img-responsive" src="<?php echo base_url(); ?>assets/adminlte/dist/img/photo1.png" alt="Photo">
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="<?php echo base_url(); ?>assets/adminlte/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="<?php echo base_url(); ?>assets/adminlte/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
