<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?><div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Tampil Data <small>Bentuk Sekolah</small></h2> &nbsp&nbsp&nbsp&nbsp
...
<tr>
                    <td></td><td> <a href="<?php echo site_url('bentuksekolah') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
                    </tr>
            </table>
           </div>   
        </div>
