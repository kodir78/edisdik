<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?>
	 <div class="row" >
                    <div class="col-md-4">
                        <h2 style="margin-top:0px">Daftar Bentuk Sekolah</h2>
                    </div>
                    <!-- message -->
		...
		<?php echo anchor(site_url('bentuksekolah/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-warning"'); ?>
		<?php echo anchor(site_url('bentuksekolah/excel'), '<i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-sm btn-success"'); ?>
		<!-- /Button Create | Export -->
                <!-- Judul --> 
                <!-- <h2>Tbl_refbentuksekolah </h2> -->
                <!-- /Judul --> 
...
$(document).ready(function() {
    var t =$('#mytable').DataTable( {
        ...
        "ajax": '<?php echo site_url('bentuksekolah/data')?>',
        "order": [[ 2, 'asc' ]],
   ...
   <!--  <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "bentuksekolah/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_bentuk_sekolah",
                            "orderable": true
                        },{"data": "nama_bentuk"},{"data": "tgl_input"},{"data": "user_input"},{"data": "tgl_update"},{"data": "user_update"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
