<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?>
	 <div class="row" >
                    <div class="col-md-4">
                        <h2 style="margin-top:0px">Daftar Tbl_profil_lembaga</h2>
                    </div>
                    <!-- message -->
		...
		<?php echo anchor(site_url('profillembaga/create'), '<i class="fa fa-files-o"></i> Create', 'class="btn btn-sm btn-warning"'); ?>
		<!-- /Button Create | Export -->
                <!-- Judul --> 
                <!-- <h2>Tbl_profil_lembaga </h2> -->
                <!-- /Judul --> 
...
$(document).ready(function() {
    var t =$('#mytable').DataTable( {
        ...
        "ajax": '<?php echo site_url('profillembaga/data')?>',
        "order": [[ 2, 'asc' ]],
        ...
        {"data": "nama_lembaga"},{"data": "alamat"},{"data": "provinsi"},{"data": "kabupaten"},{"data": "no_telpon"},{"data": "logo"},
        {
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "profillembaga/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_lembaga",
                            "orderable": true
