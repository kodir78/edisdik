<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?><div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Tampil Data <small>Jenjang Pendidikan</small></h2> &nbsp&nbsp&nbsp&nbsp
...
<tr>
                    <td width="200">Nama Jenjang Pendidikan <?php echo form_error('nama_jenjang_pendidikan') ?></td><td><input type="text" readonly=""  class="form-control" name="nama_jenjang_pendidikan" id="nama_jenjang_pendidikan" placeholder="Nama Jenjang Pendidikan" value="<?php echo $nama_jenjang_pendidikan; ?>" /></td>
                    </tr>
<tr>
...
<tr>
                    <td></td><td> <a href="<?php echo site_url('jenjangpendidikan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
                    </tr>
            </table>
           </div>   
        </div>
