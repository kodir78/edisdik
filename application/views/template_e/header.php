...
<head>
    ...
    <title>SIM TERPADU <?php echo getInfoSM('nama_lembaga');?></title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.css">
         <!-- Custom CSS -->
         <link rel="stylesheet" href="<?php echo base_url(); ?>assets/adminlte/custom.css">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-lg"><b>SIM </b>TERPADU</span>
            </a>
            ...
            <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                        <img src="<?php echo base_url() ?>assets/foto_profil/<?php echo $this->session->userdata('images'); ?> " class="img-circle" alt="User profile picture">
          ...
          <li class="user-footer">
            ...
            <div class="pull-right">
                <?php echo anchor('auth/logout', '<i class="fa fa-sign-out"></i> Logout', array('class' => 'btn btn-default btn-flat')); ?>
