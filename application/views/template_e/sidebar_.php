  ...
  foreach ($main_menu as $menu){
    ...
    if($submenu->num_rows()>0){
      ...
      foreach ($submenu->result() as $sub){
        echo "<li>".anchor($sub->url,"<i class='fa fa-circle-o'></i> <span>".strtoupper($sub->title))."</span></li>"; 
      }
      echo" </ul>
      </li>";
    }else{
                // display main menu
      echo "<li>";
      echo anchor($menu->url,"<i class='".$menu->icon."'></i><span>".strtoupper($menu->title));
      echo "</span></li>";
    }
  }
  ?>
  <!-- Akhir Menu Dinamis -->
  <!-- <li><?php echo anchor('auth/logout',"<i class='fa fa-sign-out'></i><span>LOG OUT</span>");?></li>
  </ul> -->
</section>
<!-- /.sidebar -->